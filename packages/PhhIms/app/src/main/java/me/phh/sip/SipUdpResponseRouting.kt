...
enum class SipUdpResponseTargetPolicy {
    VIA,
    PACKET_SOURCE,
}
...
internal object SipUdpResponseRouting {
    ...
    fun route(
        ...
        sourcePort: Int,
        targetPolicy: SipUdpResponseTargetPolicy = SipUdpResponseTargetPolicy.VIA,
    ): SipUdpResponseRoute {
